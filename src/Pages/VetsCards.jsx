...
specialization
    ...
    return (
         <div className=" bg-primary rounded-2xl shadow-md overflow-hidden lg:m-4 mx-auto w-full">
      ...
      <div className="p-4">
        ...
        <p className="text-sm text-gray-600"><strong>Email:</strong><span className='text-success'>{email}</span></p>
        <p className="text-sm text-gray-600"><strong>Phone:</strong> {phone}</p>
        <button className="mt-3 border-success btn btn-success w-full text-white py-2 rounded-lg hover:btn-[#BAD8B6] hover:border-[#BAD8B6] transition">
          Contact
        </button>
      </div>
    </div>
